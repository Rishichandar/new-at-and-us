...
console.log(formData.team)
  ...
  const handleChange1 = (event) => {
    ...
    handleChange2({ target: { name: "team", value: selectedNames.join(",") } });
  };
  ...
  //   try {
  //     await axios.post("http://localhost:8000/usecase", projectDetails);
  ...
  console.log("usecase  page roleid :", roleid);
